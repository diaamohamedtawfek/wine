...
class OtherOffersSearch extends StatefulWidget {
 final  List<Other> offers;
 final String idLcation;
  const OtherOffersSearch({Key? key,required this.offers,required this.idLcation}) : super(key: key);

  @override
  _OffersSerachState createState() => _OffersSerachState();
}

class _OffersSerachState extends State<OtherOffersSearch> {
            ...
            return InkWell(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(widget.offers[index].locationName.toString()
                    ,maxLines: 2,
                    style: TextStyle(
                        fontSize: 15,
                  ...
                  SizedBox(height: 5,),
                  _getOtherOffers(context,widget.offers[index])
                ],
              ),
            );
          },
  ...
  Widget _getOtherOffers(BuildContext context, Other offers) {
    return
      Container(
        child: Column(
          children: <Widget>[
